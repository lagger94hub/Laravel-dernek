        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 mb-5 mb-lg-0 order-0 order-lg-1">
                    <div class="post">
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"  enctype="multipart/form-data" action={{route('public_profile_update', ['id'=> $publicprofile->id])}} >
                            @CSRF
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    @if ($publicprofile->image)
                                        <img src="{{Storage::url($publicprofile->image)}}" alt="" height="200" width="200">
                                    @endif
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name"  class="form-control " name="address" value="{{$publicprofile->address}}">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name"  class="form-control " name="phone" value="{{$publicprofile->phone}}">
                                </div>
                            </div>
