...
@section('title', 'Pets Association')
@section('description')
    An association dedicated for helping animals and providing shelter,food and medical attention
@endsection
@section('keywords')
    pets, animal lovers, association, shelter, dogs, cats, birds, nature, medical attention, adoption, donation
@endsection
