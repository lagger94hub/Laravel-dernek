            ...
            <div class="row">
                <div class="col-md-12 col-sm-12  ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action={{route('menuUpdate', ['id'=> $data->id])}}>
                                @CSRF
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control" name="parent_id">
                                            @foreach($parentMenus as $parent)
                                                <option value={{$parent->id}} {{($parent->id) == $data->parent_id ? "selected" : ""}}>{{$parent->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
